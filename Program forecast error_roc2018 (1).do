...
egen bm_adjustment_actual_std = sd(bm_adjustment_actual_average), by(country)
...
encode weo, g(weocode)
encode ctyname, g(ctynamecode)
...
label var commodity_notexp_error "Non-commodity exporter x oil price forecast error"
...
/*
areg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , /*
*/ absorb(ctynamecode) r
