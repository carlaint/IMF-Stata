...
label var pb_adjustment "Fiscal balance forecast error"
label var high_pb_adjustment "Forecast error under high fiscal adj"
label var bm_ngdp_adj "Broad money forecast error"
label var high_bm_adjustment "Forecast error under high monetary adj"
label var ca_adjustment "CA balance forecast error"
label var high_ca_adjustment "Forecast error under high current account adj"
...
xtreg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
...
outreg2 using "Results\main_specification_${date_str}.xls", replace label ctitle(Program Forecasts) 

// GRA program period forecasts
xtreg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , fe 
outreg2 using "Results\main_specification_${date_str}.xls", append label ctitle(GRA Program Forecasts) 
...
outreg2 using "Results\main_specification_${date_str}.xls", append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\main_specification_${date_str}.xls", append label ctitle(Surveillance Forecasts)


* Alternative Specification 1 (WEO): no interactions, country*WEO fixed effects

// Program period forecasts
xtreg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , fe 
outreg2 using "Results\alt1_specification_${date_str}.xls", replace label ctitle(Program Forecasts) 

// GRA program period forecasts
xtreg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , fe 
outreg2 using "Results\alt1_specification_${date_str}.xls", append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
xtreg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , fe 
outreg2 using "Results\alt1_specification_${date_str}.xls", append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt1_specification_${date_str}.xls", append label ctitle(Surveillance Forecasts)


* Alternative Specification 2 (WEO): interactions, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
...
outreg2 using "Results\alt2_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt2_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt2_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt2_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)


* Alternative Specification 3 (WEO): no interactions, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment/*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt3_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt3_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt3_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt3_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)

* Alternative Specification 4 (WEO): interactions excluding CA balance, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt4_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt4_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt4_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt4_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)


* Alternative Specification 5 (WEO): no interactions excluding CA balance, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt5_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt5_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt5_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt5_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)

* Alternative Specification 6 (WEO): high fiscal adjustment interaction, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt6_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt6_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt6_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt6_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)

* Alternative Specification 7 (WEO): high current account adjustment interaction, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt7_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt7_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment high_ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt7_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt7_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)

* Alternative Specification 8 (WEO): high monetary adjustment interaction, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt8_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt8_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment /*
*/ oil_notexp_error oil_exp_error commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt8_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt8_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)

* Alternative Specification 9 (WEO): interactions excluding oil and non-oil exporters, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt9_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt9_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment high_pb_adjustment bm_ngdp_adj high_bm_adjustment ca_adjustment high_ca_adjustment /*
*/ commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt9_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt9_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)


* Alternative Specification 10 (WEO): no interactions excluding oil and non-oil exporters, country+WEO fixed effects
// Program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment/*
*/ commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1 | program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt10_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) replace label ctitle(Program Forecasts) 

// GRA program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_gra==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt10_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(GRA Program Forecasts) 

// PRGT program period forecasts
reg growth_error partnergrowth_error pb_adjustment bm_ngdp_adj ca_adjustment /*
*/ commodity_notexp_error commodity_exp_error time_to_forecast GFC cty_d* weo_d* /*
*/  if (review=="") & (program_is_prgt==1) & years_to_forecast>=0  & year <= 2016 & (month(action)<=10 | year!=year(action)) , r
outreg2 using "Results\alt10_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(PRGT Program Forecasts) 
...
outreg2 using "Results\alt10_specification_${date_str}.xls", drop (o.* cty_d* weo_d*) append label ctitle(Surveillance Forecasts)
