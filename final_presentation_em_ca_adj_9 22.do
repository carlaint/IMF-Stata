...
foreach x in change_ca_gdp growth_dem_part growth_dem_dom growth_NEER growth_REL_CPI growth_TT if year>2008& year<2017&comm!=1 {
bys year: egen sum_gdp=mean(`x')
}

sort year
drop if year==year[_n-1]
keep year sum_equity_assets sum_equity_liab sum_debt_assets sum_debt_liab sum_fdi_assets sum_fdi_liab sum_port_debt_assets sum_port_debt_liab sum_oi_assets sum_oi_liab sum_gdp



table year change_ca_gdp if year>2008& year<2017&comm!=1

summarize change_ca_gdp growth_dem_part growth_dem_dom growth_NEER growth_REL_CPI growth_TT 
...
by year, sort: egen y_m=mean(change_ca_gdp) if year>1980& year<2017&comm==1  &l.growth_dem_part!=. & growth_dem_part!=.& l.growth_dem_dom!=.&growth_dem_dom!=.& l.growth_NEER!=. &growth_NEER!=. & l.growth_REL_CPI!=. &growth_REL_CPI!=. & l.growth_TT!=.&growth_TT!=.
